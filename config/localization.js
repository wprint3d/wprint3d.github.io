...
export const translations = {
  en: {
    ...
    docker: {
      ...
      recommendedBody: "The process consists of downloading the pre-built images and running them in Docker containers on the host device.",
      progressHint: "Click or tap on the steps to keep track of your progress.",
      ...
      installEngineTitle: "Install the Docker engine",
      installEngineDescription: "Install the Docker engine on the target machine.",
      postInstallTitle: "Follow the post-installation steps",
      postInstallDescription: "Run the post-installation steps for the Docker engine.",
  ...
  es: {
    ...
    docker: {
      ...
      recommendedBody: "El proceso consiste en descargar las imágenes precompiladas y ejecutarlas en contenedores Docker en el dispositivo host.",
      progressHint: "Haz clic o toca los pasos para seguir tu progreso.",
      ...
      installEngineTitle: "Instala Docker Engine",
      installEngineDescription: "Instala Docker Engine en la máquina de destino.",
      postInstallTitle: "Sigue los pasos posteriores a la instalación",
      postInstallDescription: "Ejecuta los pasos posteriores a la instalación de Docker Engine.",
  ...
  fr: {
    ...
    docker: {
      ...
      recommendedBody: "Le processus consiste à télécharger les images préconstruites et à les exécuter dans des conteneurs Docker sur l'appareil hôte.",
      progressHint: "Cliquez ou appuyez sur les étapes pour suivre votre progression.",
      ...
      installEngineTitle: "Installer Docker Engine",
      installEngineDescription: "Installez Docker Engine sur la machine cible.",
      postInstallTitle: "Suivre les étapes post-installation",
      postInstallDescription: "Exécutez les étapes post-installation de Docker Engine.",
  ...
  pt: {
    ...
    docker: {
      ...
      recommendedBody: "O processo consiste em baixar as imagens pré-compiladas e executá-las em contêineres Docker no dispositivo host.",
      progressHint: "Clique ou toque nos passos para acompanhar seu progresso.",
      ...
      installEngineTitle: "Instale o Docker Engine",
      installEngineDescription: "Instale o Docker Engine na máquina de destino.",
      postInstallTitle: "Siga as etapas pós-instalação",
      postInstallDescription: "Execute as etapas pós-instalação do Docker Engine.",
  ...
  it: {
    ...
    docker: {
      ...
      recommendedBody: "Il processo consiste nello scaricare le immagini precompilate ed eseguirle in container Docker sul dispositivo host.",
      progressHint: "Fai clic o tocca i passaggi per tenere traccia dei tuoi progressi.",
      ...
      installEngineTitle: "Installa Docker Engine",
      installEngineDescription: "Installa Docker Engine sulla macchina di destinazione.",
      postInstallTitle: "Segui i passaggi post-installazione",
      postInstallDescription: "Esegui i passaggi post-installazione di Docker Engine.",
  ...
  de: {
    ...
    docker: {
      ...
      recommendedBody: "Der Prozess besteht darin, die vorgefertigten Images herunterzuladen und sie in Docker-Containern auf dem Host-Gerät auszuführen.",
      progressHint: "Klicken oder tippen Sie auf die Schritte, um Ihren Fortschritt zu verfolgen.",
      ...
      installEngineTitle: "Docker Engine installieren",
      installEngineDescription: "Installieren Sie Docker Engine auf der Zielmaschine.",
      postInstallTitle: "Den Schritten nach der Installation folgen",
      postInstallDescription: "Führen Sie die Schritte nach der Installation von Docker Engine aus.",
  ...
  es_AR: {
    ...
    docker: {
      ...
      installEngineTitle: "Instalá Docker Engine",
      installEngineDescription: "Instalá Docker Engine en la máquina de destino.",
      postInstallTitle: "Seguí los pasos posteriores a la instalación",
      postInstallDescription: "Ejecutá los pasos posteriores a la instalación de Docker Engine.",
